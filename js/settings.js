...
export class Settings
{
    ...
    //  Tamaño de los tiles 16x16 (20filas x 20columnas)
    static tamTile = 32;

    //  DIMENSIONES EN PIXELS DEL CANVAS
    static canvasAncho = Escenarios.niveles.uno[0].length * Settings.tamTile;
    static canvasAlto = Escenarios.niveles.uno.length * Settings.tamTile;
    ...
    static modo3D = false;// true = Pseudo3D, false = Mapa2D
