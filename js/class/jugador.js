...
import { textos } from "../functions/functions.js";
...
export class Jugador
{
	...
	{
		//	VISIÓN (RENDER)
        // Settings.canvasAncho = NRO_RAYOS a castear (ancho pantalla)
		this.numRayos = 1;	// Cantidad de rayos que vamos a castear (los mismos que tenga el ancho del canvas)
		...
		var anguloRayo = this.anguloRotacion;
	...
	dibuja()
	{
		...
		if (!Settings.modo3D)
		{
            ...
            textos('x:' + x + ' ' + 'y: ' + y, '20px arial', '#ffff11', 0, 18);
		}
	}
